---
title: "Analysis - Temperature - All models"
author: "Tom Offrede"
output:
  html_document:
    toc: true
...
# dat <- dat |>
#   mutate(closenessOG = closeness,
#          similarityOG = similarity,
#          likeabilityOG = likeability,
#          becomeFriendsOG = becomeFriends) |> 
#   pivot_longer(col= c("closeness", "similarity", "likeability", "becomeFriends"),
#                names_to = "rcitType",
#                values_to = "rcitRating") |> 
#   rename(closeness = closenessOG,
#          similarity = similarityOG,
#          likeability = likeabilityOG,
#          becomeFriends = becomeFriendsOG)
```
...
#   ggplot(dat |> filter(ROI==roi), aes(timeN, temperature, color=speaker))+
#     geom_point()+
...
#     ggplot(dat |> filter(ROI==roi, condition==con), aes(timeN, temperature, color=speaker))+
#     geom_point()+
#     geom_smooth(method="lm")+
#     facet_wrap(~dyad, scales = "free_x")+
...
#     ungroup()
#     ggplot(d, aes(timeN, temperature, color=task))+
#       geom_point()+
#       geom_smooth(method="lm")+
...
```{r}
# for(roi in unique(dat$ROI)){
#   ggplot(dat |> filter(ROI==roi, grepl("-A", speaker)), aes(timeN, tempDiff))+
#     geom_point()+
#     geom_smooth(method="lm")+
#     facet_wrap(~dyad, scales = "free_x")+
#     ggtitle(roi)
...
#   
#   for(con in unique(dat$condition)){
#     ggplot(dat |> filter(ROI==roi, grepl("-A", speaker), condition==con), aes(timeN, tempDiff))+
#     geom_point()+
#     geom_smooth(method="lm")+
#     facet_wrap(~dyad, scales = "free_x")+
#     ggtitle(paste(roi, "-", con, "condition"))
...
### New Analysis with `ordinal` package
...
#          rcitRatingC = rcitRating - 5)
# 
# data$effect <- factor(data$effect,
#                       levels = c("decrease", "ns", "increase"),
#                       ordered = TRUE)
# 
# data$rcitRating <- factor(data$rcitRating,
#                           levels = c("1", "2", "3", "4", "5", "6", "7", "8", "9"),
#                           ordered = TRUE)
```

effect ~ rcitRatingC + rcitRatingC : rcitType + (1+rcitRatingC : rcitType|speaker) + (1+rcitRatingC : rcitType|dyad)


##### Lists
```{r}
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Forehead", section=="Lists")))
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Nose", section=="Lists")))
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Eyes", section=="Lists")))
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Cheeks", section=="Lists")))
# 
# 
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Forehead", section=="Lists")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Eyes", section=="Lists")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Nose", section=="Lists")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Cheeks", section=="Lists")))
```
...
```{r}
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Forehead", section=="Diapix")))
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Nose", section=="Diapix")))
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Eyes", section=="Diapix")))
# summary(m <- ordinal::clmm(rcitRating ~ effect + (1|speaker) + (1|dyad), data|> filter(ROI=="Cheeks", section=="Diapix")))
# 
# 
# 
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Forehead", section=="Diapix")))
# 
# p <- ggeffects::ggpredict(m, terms = c("rcitRatingC")) |>
#   as_tibble() |> 
#   mutate()
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Eyes", section=="Diapix")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Nose", section=="Diapix")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1|speaker), data |> filter(ROI=="Cheeks", section=="Diapix")))
```

##### Entire experiment
```{r}
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1+rcitRatingC : rcitType|speaker) + (1+rcitRatingC : rcitType|dyad), data |> filter(ROI=="Forehead", section=="entireExp")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1+rcitRatingC : rcitType|speaker) + (1+rcitRatingC : rcitType|dyad), data |> filter(ROI=="Eyes", section=="entireExp")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1+rcitRatingC : rcitType|speaker) + (1+rcitRatingC : rcitType|dyad), data |> filter(ROI=="Nose", section=="entireExp")))
# 
# summary(m <- ordinal::clmm(effect ~ rcitRatingC + rcitRatingC : rcitType + (1+rcitRatingC : rcitType|speaker) + (1+rcitRatingC : rcitType|dyad), data |> filter(ROI=="Cheeks", section=="entireExp")))
```

### "gaussian" regression - questionnaire scores as predictors
(but logistic for condition ~ effect)
...
### multinomial regression -- questionnaire scores as predictors
...
# summary(m <- lm(becomeFriends ~ effect, d |> filter(ROI=="Nose")))
...
Preferred model: `temperature ~ timeN : roomTemp + (timeN||speaker)`

```{r}
ggplot(dat |> filter(ROI=="Nose"), aes(timeN, temperature))+
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker) , dat |> filter(ROI=="Nose")))

summary(m1 <- lmer(temperature ~ timeN + roomTemp + (timeN||speaker) , dat |> filter(ROI=="Nose")))


summary(m1 <- lmer(temperature ~ timeN + (timeN||speaker) + (1|dyad), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN + timeN : closeness  + (timeN||speaker) + (1|dyad), dat |> filter(ROI=="Nose")))

# a <- broom.mixed::tidy(m2, effects="ran_vals", conf.int=TRUE) |> 
#   filter(group=="speaker") |> 
#   mutate(estimate = estimate + 32.484731)
# coef(m2)
# lattice::dotplot(ranef(m1))["speaker"]
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1|speaker), dat |> filter(ROI=="Nose")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (1|speaker), dat |> filter(ROI=="Nose")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
...
ggplot(dat |> filter(ROI=="Nose"), aes(x=timeN, y=temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~as.factor(likeability))
```

No effect of BFI scores
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m1 <- lmer(temperature ~ timeN : neuroticism + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN : extraversion + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m3 <- lmer(temperature ~ timeN : agreeableness + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m4 <- lmer(temperature ~ timeN : openness + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
summary(m5 <- lmer(temperature ~ timeN : conscientiousness + (1+timeN|speaker), dat |> filter(ROI=="Nose")))
...
Preferred model: `temperature ~ timeN + roomTemp + (1+timeN|speaker)`

```{r}
ggplot(dat |> filter(ROI=="Forehead"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (1+timeN|speaker), dat |> filter(ROI=="Forehead"))) # but failed to converge
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN : closeness + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN : similarity + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ timeN : likeability + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ timeN : becomeFriends + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN : neuroticism + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN : extraversion + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ timeN : agreeableness + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ timeN : openness + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
summary(m5 <- lmer(temperature ~ timeN : conscientiousness + (1+timeN|speaker), dat |> filter(ROI=="Forehead")))
...
Preferred model: `temperature ~ timeN + (timeN||speaker)`


```{r}
ggplot(dat |> filter(ROI=="Eyes"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (timeN||speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN : condition + (timeN||speaker), dat |> filter(ROI=="Eyes")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN : closeness + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN : similarity + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ timeN : likeability + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ timeN : becomeFriends + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN : neuroticism + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN : extraversion + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ timeN : agreeableness + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ timeN : openness + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
summary(m5 <- lmer(temperature ~ timeN : conscientiousness + (1+timeN|speaker), dat |> filter(ROI=="Eyes")))
...
```{r}
ggplot(dat |> filter(ROI=="Cheeks"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN : closeness + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN : similarity + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ timeN : likeability + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ timeN : becomeFriends + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN : neuroticism + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN : extraversion + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ timeN : agreeableness + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ timeN : openness + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
summary(m5 <- lmer(temperature ~ timeN : conscientiousness + (1+timeN|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Nose"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker) , dat |> filter(task=="Lists", ROI=="Nose")))

summary(m1 <- lmer(temperature ~ timeN + roomTemp + (timeN||speaker) , dat |> filter(task=="Lists", ROI=="Nose")))

summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (timeN||speaker) , dat |> filter(task=="Lists", ROI=="Nose")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Forehead"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Eyes"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (timeN||speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN : condition + (timeN||speaker), dat |> filter(task=="Lists", ROI=="Eyes")))

anova(m0, m1) # this timeN the model without `roomTemp` was preferred
anova(m0, m2)
```

No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Cheeks"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Nose"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker) , dat |> filter(task=="Diapix", ROI=="Nose")))

summary(m1 <- lmer(temperature ~ timeN + roomTemp + (timeN||speaker) , dat |> filter(task=="Diapix", ROI=="Nose")))

summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (timeN||speaker) , dat |> filter(task=="Diapix", ROI=="Nose")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Forehead"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Eyes"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN : condition + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Cheeks"), aes(timeN, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + roomTemp + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN : condition + roomTemp + (1+timeN|speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + timeN : closeness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN + timeN : similarity + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ timeN + timeN : likeability + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ timeN + timeN : becomeFriends + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ timeN + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ timeN + timeN : extraversion + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ timeN + timeN : agreeableness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ timeN + timeN : openness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m5 <- lmer(temperature ~ timeN + timeN : conscientiousness + (timeN||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
...
#### All analyses in one loop

```{r}
eff <- data.frame(matrix(nrow=0, ncol=9))
names(eff) <- c("section", "ROI", "roomTemp", "smallerAIC", "item",  "estimate", "SE", "t", "p")

for(s in unique(dat$task)){
  for(r in unique(dat$ROI)){
    
    # without roomTemp
    
    c <- broom.mixed::tidy(m <- lmer(temperature ~ timeN + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : closeness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without",
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "closeness",
                           c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : similarity + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "similarity",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : likeability + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "likeability",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "becomeFriends",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "neuroticism",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : extraversion + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "extraversion",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "agreeableness",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : openness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without",
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "openness",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "without", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "conscientiousness",
    ...
    c <- broom.mixed::tidy(m <- lmer(temperature ~ roomTemp + timeN + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : closeness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "closeness",
                           c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : similarity + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "similarity",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : likeability + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "likeability",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : becomeFriends + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "becomeFriends",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : neuroticism + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "neuroticism",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : extraversion + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "extraversion",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : agreeableness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "agreeableness",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : openness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "openness",
    ...
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ timeN + roomTemp + timeN : conscientiousness + (1+timeN|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    eff[nrow(eff)+1,] <- c(s, r, "with", 
                           ifelse(a$AIC[2] - a$AIC[1] <= -2, "yes", "no"),
                           "conscientiousness",
...
d <- eff |> 
  mutate_at(c("estimate", "SE", "t", "p"), as.numeric) |> 
  mutate_at(c("section", "ROI", "roomTemp", "smallerAIC", "item"), as.factor)|> 
  filter(smallerAIC == "yes",
         p < 0.05) |>
  mutate(pCorrected = p * nrow(eff),
         stillSign = ifelse(pCorrected < 0.05, "*", "ns"))
```
...
Preferred model: `tempDiff ~ timeN + (1+timeN|dyad)`

```{r}
ggplot(dat |> filter(ROI=="Nose"), aes(timeN, tempDiff))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempDiff ~ timeN + (1+timeN|dyad), dat |> filter(ROI=="Nose", grepl("-A", speaker))))
summary(m1 <- lmer(tempDiff ~ timeN : condition + (1+timeN|dyad), dat |> filter(ROI=="Nose", grepl("-A", speaker))))
...
```{r}
ggplot(dat |> filter(ROI=="Forehead"), aes(timeN, tempDiff))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempDiff ~ timeN + (1+timeN|dyad), dat |> filter(ROI=="Forehead", grepl("-A", speaker))))
summary(m1 <- lmer(tempDiff ~ timeN : condition + (1+timeN|dyad), dat |> filter(ROI=="Forehead", grepl("-A", speaker))))
...
```{r}
ggplot(dat |> filter(ROI=="Eyes"), aes(timeN, tempDiff))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempDiff ~ timeN + (1+timeN|dyad), dat |> filter(ROI=="Eyes", grepl("-A", speaker))))
summary(m1 <- lmer(tempDiff ~ timeN : condition + (1+timeN|dyad), dat |> filter(ROI=="Eyes", grepl("-A", speaker))))
...
```{r}
ggplot(dat |> filter(ROI=="Cheeks"), aes(timeN, tempDiff))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempDiff ~ timeN + (1+timeN|dyad), dat |> filter(ROI=="Cheeks", grepl("-A", speaker))))
summary(m1 <- lmer(tempDiff ~ timeN : condition + (1+timeN|dyad), dat |> filter(ROI=="Cheeks", grepl("-A", speaker))))
