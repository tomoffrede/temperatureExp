...
########################################
Trying poisson regression etc

```{r}
# is this offset(condCount) right? (generally: not sure what "offset" means here)
dt <- d |> 
...
summary(m <- glm(count ~ condition / effect, dt |> filter(ROI=="Nose"), family="poisson"))
