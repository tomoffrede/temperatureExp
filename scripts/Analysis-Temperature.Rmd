...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m1 <- lmer(temperature ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(temperature ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m3 <- lmer(temperature ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(temperature ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m4 <- lmer(temperature ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
...
summary(m1 <- lmer(temperature ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Nose"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker) , dat |> filter(task=="Lists", ROI=="Nose")))

summary(m1 <- lmer(temperature ~ time + roomTemp + (time||speaker) , dat |> filter(task=="Lists", ROI=="Nose")))

summary(m2 <- lmer(temperature ~ time : condition + roomTemp + (time||speaker) , dat |> filter(task=="Lists", ROI=="Nose")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ roomTemp + time : closeness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ roomTemp + time : similarity + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ roomTemp + time : likeability + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ roomTemp + time : becomeFriends + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ roomTemp + time : neuroticism + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ roomTemp + time : extraversion + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ roomTemp + time : agreeableness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ roomTemp + time : openness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
summary(m5 <- lmer(temperature ~ roomTemp + time : conscientiousness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Nose")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Forehead"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ time + roomTemp + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ time : condition + roomTemp + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ roomTemp + time : closeness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ roomTemp + time : similarity + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ roomTemp + time : likeability + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ roomTemp + time : becomeFriends + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ roomTemp + time : neuroticism + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ roomTemp + time : extraversion + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ roomTemp + time : agreeableness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ roomTemp + time : openness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
summary(m5 <- lmer(temperature ~ roomTemp + time : conscientiousness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Forehead")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Eyes"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ time + roomTemp + (time||speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ time : condition + (time||speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ roomTemp + time : closeness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ roomTemp + time : similarity + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ roomTemp + time : likeability + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ roomTemp + time : becomeFriends + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ roomTemp + time : neuroticism + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ roomTemp + time : extraversion + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ roomTemp + time : agreeableness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ roomTemp + time : openness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
summary(m5 <- lmer(temperature ~ roomTemp + time : conscientiousness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Eyes")))
...
```{r}
ggplot(dat |> filter(task=="Lists", ROI=="Cheeks"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ time + roomTemp + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ time : condition + roomTemp + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ roomTemp + time : closeness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ roomTemp + time : similarity + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ roomTemp + time : likeability + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ roomTemp + time : becomeFriends + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ roomTemp + time : neuroticism + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ roomTemp + time : extraversion + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ roomTemp + time : agreeableness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ roomTemp + time : openness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
summary(m5 <- lmer(temperature ~ roomTemp + time : conscientiousness + (1+time|speaker), dat |> filter(task=="Lists", ROI=="Cheeks")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Nose"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker) , dat |> filter(task=="Diapix", ROI=="Nose")))

summary(m1 <- lmer(temperature ~ time + roomTemp + (time||speaker) , dat |> filter(task=="Diapix", ROI=="Nose")))

summary(m2 <- lmer(temperature ~ time : condition + roomTemp + (time||speaker) , dat |> filter(task=="Diapix", ROI=="Nose")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ time : closeness + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ time : similarity + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ time : likeability + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m2 <- lmer(temperature ~ time : extraversion + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m4 <- lmer(temperature ~ time : openness + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Nose")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Forehead"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ time + roomTemp + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ time : condition + roomTemp + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ time : closeness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ time : similarity + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ time : likeability + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m2 <- lmer(temperature ~ time : extraversion + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m4 <- lmer(temperature ~ time : openness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Forehead")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Eyes"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ time + roomTemp + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ time : condition + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ time : closeness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ time : similarity + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ time : likeability + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m2 <- lmer(temperature ~ time : extraversion + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m4 <- lmer(temperature ~ time : openness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Eyes")))
...
```{r}
ggplot(dat |> filter(task=="Diapix", ROI=="Cheeks"), aes(time, temperature))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ time + roomTemp + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ time : condition + roomTemp + (1+time|speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ time : closeness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ time : similarity + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ time : likeability + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ time : becomeFriends + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(temperature ~ time + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m1 <- lmer(temperature ~ time : neuroticism + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m2 <- lmer(temperature ~ time : extraversion + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m3 <- lmer(temperature ~ time : agreeableness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m4 <- lmer(temperature ~ time : openness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
summary(m5 <- lmer(temperature ~ time : conscientiousness + (time||speaker), dat |> filter(task=="Diapix", ROI=="Cheeks")))
...
```{r}
eff <- data.frame(matrix(nrow=0, ncol=8))
names(eff) <- names(c("section", "ROI", "roomTemp", "item", "estimate", "SE", "t", "p"))
...
for(s in unique(dat$task)){
  for(r in unique(dat$ROI)){
    ...
    c <- broom.mixed::tidy(m <- lmer(temperature ~ time + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : closeness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "closeness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : similarity + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "similarity",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : likeability + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "likeability",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : becomeFriends + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "becomeFriends",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : neuroticism + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "neuroticism",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : extraversion + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "extraversion",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : agreeableness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "agreeableness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : openness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "openness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ time : conscientiousness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "without", "conscientiousness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    
    # with roomTemp
    
    c <- broom.mixed::tidy(m <- lmer(temperature ~ roomTemp + time + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : closeness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "closeness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : similarity + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "similarity",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : likeability + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "likeability",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : becomeFriends + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "becomeFriends",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : neuroticism + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "neuroticism",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : extraversion + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "extraversion",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : agreeableness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "agreeableness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : openness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "openness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
    c1 <- broom.mixed::tidy(m1 <- lmer(temperature ~ roomTemp + time : conscientiousness + (1+time|speaker), dat |> filter(task==s, ROI==r)))
    a <- anova(m, m1)
    if(a$AIC[2] - a$AIC[1] <= -2){
      eff[nrow(eff)+1,] <- c(s, r, "with", "conscientiousness",
                             c1$estimate[2], c1$std.error[2], c1$statistic[2], c1$p.value[2])
    }
  }
}
