...
<!-- # ```{r} -->
<!-- # ggplot(ipus |> filter(task=="Lists"), aes(condition, f0medz))+ -->
<!-- #   geom_boxplot() -->
<!-- #  -->
<!-- # ggplot(ipus |> filter(task=="Lists"), aes(condition, f0sdz))+ -->
<!-- #   geom_boxplot() -->
<!-- #  -->
<!-- # ggplot(ipus |> filter(task=="Lists"), aes(condition, f0max))+ -->
<!-- #   geom_boxplot() -->
<!-- # ``` -->
<!-- #  -->
<!-- # ```{r} -->
...
<!-- #   group_by(speaker) |>  -->
<!-- #   filter(task=="Lists") |>  -->
<!-- #   filter(turnOverall == 1:(length(turnOverall))*0.1 | (length(turnOverall))*0.9:(length(turnOverall))) -->
<!-- #  -->
<!-- # ggplot(dat, aes(x=turnOverall, y=f0max))+ -->
<!-- #   geom_point()+ -->
<!-- #   facet_wrap(~condition)+ -->
<!-- #   geom_smooth(method="lm") -->
<!-- #  -->
<!-- # ggplot(dat, aes(x=turnOverall, y=f0med))+ -->
<!-- #   geom_point()+ -->
<!-- #   facet_wrap(~condition)+ -->
<!-- #   geom_smooth(method="lm") -->
<!-- #  -->
<!-- # ggplot(dat, aes(x=turnOverall, y=f0sd))+ -->
<!-- #   geom_point()+ -->
<!-- #   facet_wrap(~condition)+ -->
<!-- #   geom_smooth(method="lm") -->
<!-- # ``` -->
...
<!-- ```{r} -->
<!-- summary(lmer(f0medz ~ condition + (1|speaker), ipus |> filter(task=="Lists"))) -->
<!-- summary(lmer(f0sdz ~ condition + (1|speaker), ipus |> filter(task=="Lists"))) -->
<!-- summary(lmer(f0maxz ~ condition + (1|speaker), ipus |> filter(task=="Lists"))) -->
<!-- ``` -->
...
-   Across entire experiment: f0 median increases in both conditions.
-   Only during question lists: f0 median doesn't change in any condition.
-   Only during Diapix: f0 median increases in both conditions (the model suggests there's a difference between conditions but it doesn't seem true).
...
### Temperature (numerical) affecting f0
