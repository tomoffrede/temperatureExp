...
Preferred model: `tempz ~ time + (time||speaker)`

```{r}
ggplot(dat |> filter(ROI=="Nose"), aes(time, tempz))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempz ~ time + (time||speaker) , dat |> filter(ROI=="Nose")))

summary(m1 <- lmer(tempz ~ time : condition + (time||speaker) , dat |> filter(ROI=="Nose")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m1 <- lmer(tempz ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(tempz ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m3 <- lmer(tempz ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m4 <- lmer(tempz ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Nose")))
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m1 <- lmer(tempz ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m2 <- lmer(tempz ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m3 <- lmer(tempz ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m4 <- lmer(tempz ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Nose")))
summary(m5 <- lmer(tempz ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Nose")))
...
Preferred model: `tempz ~ time + (1+time|speaker)`

```{r}
ggplot(dat |> filter(ROI=="Forehead"), aes(time, tempz))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(tempz ~ time : condition + (1+time|speaker), dat |> filter(ROI=="Forehead"))) # but failed to converge
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(tempz ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(tempz ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m3 <- lmer(tempz ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m4 <- lmer(tempz ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Forehead")))
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m1 <- lmer(tempz ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m2 <- lmer(tempz ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m3 <- lmer(tempz ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m4 <- lmer(tempz ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
summary(m5 <- lmer(tempz ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Forehead")))
...
```{r}
ggplot(dat |> filter(ROI=="Eyes"), aes(time, tempz))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempz ~ time + (time||speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(tempz ~ time : condition + (time||speaker), dat |> filter(ROI=="Eyes")))
...
No effect of perception of partner
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(tempz ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(tempz ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m3 <- lmer(tempz ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m4 <- lmer(tempz ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Eyes")))
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m1 <- lmer(tempz ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m2 <- lmer(tempz ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m3 <- lmer(tempz ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m4 <- lmer(tempz ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
summary(m5 <- lmer(tempz ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Eyes")))
...
Cheeks did not change tempz.

Preferred model: `tempz ~ time + (1+time|speaker)`

```{r}
ggplot(dat |> filter(ROI=="Cheeks"), aes(time, tempz))+
  geom_point()+
  geom_smooth(method="lm")+
  facet_wrap(~condition)
```
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(tempz ~ time : condition + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(tempz ~ time : closeness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(tempz ~ time : similarity + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m3 <- lmer(tempz ~ time : likeability + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m4 <- lmer(tempz ~ time : becomeFriends + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
...
```{r}
summary(m0 <- lmer(tempz ~ time + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m1 <- lmer(tempz ~ time : neuroticism + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m2 <- lmer(tempz ~ time : extraversion + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m3 <- lmer(tempz ~ time : agreeableness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m4 <- lmer(tempz ~ time : openness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
summary(m5 <- lmer(tempz ~ time : conscientiousness + (1+time|speaker), dat |> filter(ROI=="Cheeks")))
